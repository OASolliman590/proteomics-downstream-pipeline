# Implementation Plan: Versioned annotation, protein groups and gene sets

**Date:** 2026-09-12. **Spec:** [spec.md](spec.md). **Roadmap:** R07.
...
- `src/proteomics_pipeline/resources.py; schemas/resource.schema.json` — Local resource snapshot registry.
- `src/proteomics_pipeline/resources.py; configs/resources/` — Explicit resource preparation command.
- `r/proteomicsCore/R/mapping.R` — Species-aware identifier mapping.
- `r/proteomicsCore/R/mapping.R` — Orthology evidence preservation.
- `r/proteomicsCore/R/gene_matrix.R` — Label-independent gene representatives.
- `r/proteomicsCore/R/gene_matrix.R` — Ambiguous protein-group policy.
- `r/proteomicsCore/R/gene_matrix.R` — Finite pathway matrix and model.
- `r/proteomicsCore/R/genesets.R` — Gene-set overlap eligibility.
- `r/proteomicsCore/R/genesets.R` — Measured gene background for ORA.
- `tests/contract/test_resources.py; r/proteomicsCore/tests/testthat/test-mapping.R` — Resource/mapping regression fixtures.
