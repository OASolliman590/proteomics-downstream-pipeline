...
Release calibration and the medium benchmark are executed here, not in Phase 1. requirements.lock and renv.lock contain actually solved/restored versions; do not invent tested pins in advance.
