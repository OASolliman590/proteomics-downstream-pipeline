...
**Phase:** 1. **Status:** frozen; dispatch requires explicit GO R01.
...
Start only with the exact files and commands in [the R01 brief](../001-downstream-proteomics/IMPLEMENTATION_BRIEF_R01.md). The current recovery tests remain untouched.
