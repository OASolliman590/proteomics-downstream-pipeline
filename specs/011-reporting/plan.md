# Implementation plan — R10

**Phase:** 1 (R10a: 091–094); 3 (R10b: 095–100). **Status:** frozen; dispatch requires exact subpacket prerequisites and authorization.
...
R10a accepts V091–V094 using the thin offline HTML report and runs serially after R05. R10b accepts V095–V100 only after R10a/R08/R09 and re-exercises V091–V094 read-only for compatibility. No acceptance ID is duplicated or renumbered.
